...
<div class="container-fluid mt-2">
    <div class="row justify-content-center">
        ...
        <div class="col-md-9">
            <div class="row">
              <div class="col-md-1">
                <i class="fad fa-home-alt fa-6x text-success"></i>
              </div>
              <div class="col-md-11 text-left mt-4 ">
               <h1 class="ml-3 display-4 font-weight-normal"> AVAILABLE ROOMS</h1>
              </div>
            </div>
            <hr>
        <form method="post">
                       ...
                       <table id="row-select" class="thead-light display table table-bordered table-hover text-center">
                                        ...
                                        <tbody>
                                            ...
                                            LEFT JOIN users u ON u.id = r.user WHERE r.status = 'Available' ";
                                            ...
                                            LEFT JOIN district d ON d.id = r.district_id
                                            LEFT JOIN area a ON a.id = r.area_id
                                            LEFT JOIN users u ON u.id = r.user WHERE user = '$id' AND r.status = 'Available' ";
                                            $result = $con->query($query);
